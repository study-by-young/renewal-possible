...
<script src="${pageContext.request.contextPath}/resources/js/plugins/extensions/jquery_ui/widgets.min.js"></script>
	...
	<div class="x_copyr_main_wrapper bg-white float_lef">
		<div class="container">
				<div class="x_footer_top_right">
 			<div class="row no-gutters justify-content-center">
						<div class="x_footer_top_title_box x_footer_top_title_box1" style="padding:10px">
						...
						<div class="x_footer_top_title_box" style="padding:10px">
                            <div class="x_footer_top_title_box_icon_cont">
	...
	<div class="x_copyr_main_wrapper bg-indigo float_left">

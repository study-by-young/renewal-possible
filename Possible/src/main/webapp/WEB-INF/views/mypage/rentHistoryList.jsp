							...
							<div class="lr_bc_first_box_main_wrapper">
								...
								<div class="col-md-12">
									<div class="dash"
										...
										<div class="blog_single_comment_heading">
											<h4 style="font-weight: 600; padding-left: 20px;">나의
												렌트내역</h4>
										</div>
									</div>
								</div>
								...
								<div class="col-12">
									<div class="x_car_book_tabs_content_main_wrapper my-4"
										...
										<div class="row">
											<c:forEach var="est" items="${historyList}"
												varStatus="status">
																			...
																			<div class="card border-primary-300 border-1">
																				<div class="card-body">
																					<div class="row align-items-center">
																						...
																						<div class="col-8" style="padding-left: 0px">
																							<span class="list-unstyled mb-0"> <fmt:formatNumber
																									value="${est.price }" pattern="#,###" />원
																							</span>
																						</div>
											...
											<div class="card-body">
												<div class="row">
													<div class="col-12 text-center">
														<h6 class="py-5">
															아직 랜트 내역이 없습니다!<br>여행갈카 렌트 서비스를 이용해 여행을 떠나보세요!
														</h6>
													</div>
												</div>
											</div>

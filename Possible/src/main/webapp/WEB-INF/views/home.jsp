							...
							<div class="row">
								...
								<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="x_car_offer_main_boxes_wrapper float_left">
										...
										<div class="x_car_offer_img float_left">
											<img src="${pageContext.request.contextPath}/resources/images/c2.png" alt="img">
										</div>
										<div class="x_car_offer_price float_left">
											<div class="x_car_offer_price_inner">
												<h3>$25</h3>
								...
								<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="x_car_offer_main_boxes_wrapper float_left">
										...
										<div class="x_car_offer_img float_left">
											<img src="${pageContext.request.contextPath}/resources/images/c3.png" alt="img">
										</div>
										<div class="x_car_offer_price float_left">
											<div class="x_car_offer_price_inner">
												<h3>$25</h3>
								...
								<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="x_car_offer_main_boxes_wrapper float_left">
										...
										<div class="x_car_offer_img float_left">
											<img src="${pageContext.request.contextPath}/resources/images/c4.png" alt="img">
										</div>
										<div class="x_car_offer_price float_left">
											<div class="x_car_offer_price_inner">
												<h3>$25</h3>
								...
								<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="x_car_offer_main_boxes_wrapper float_left">
										...
										<div class="x_car_offer_img float_left">
											<img src="${pageContext.request.contextPath}/resources/images/c5.png" alt="img">
										</div>
										<div class="x_car_offer_price float_left">
											<div class="x_car_offer_price_inner">
												<h3>$25</h3>
								...
								<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="x_car_offer_main_boxes_wrapper float_left">
										...
										<div class="x_car_offer_img float_left">
											<img src="${pageContext.request.contextPath}/resources/images/c6.png" alt="img">
										</div>
										<div class="x_car_offer_price float_left">
											<div class="x_car_offer_price_inner">
												<h3>$25</h3>
								...
								<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="x_car_offer_main_boxes_wrapper float_left">
										...
										<div class="x_car_offer_img float_left">
											<img src="${pageContext.request.contextPath}/resources/images/c7.png" alt="img">
										</div>
										<div class="x_car_offer_price float_left">
											<div class="x_car_offer_price_inner">
												<h3>$25</h3>
								...
								<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 col-12">
									<div class="x_car_offer_main_boxes_wrapper float_left">
										...
										<div class="x_car_offer_img float_left">
											<img src="${pageContext.request.contextPath}/resources/images/c8.png" alt="img">
										</div>
										<div class="x_car_offer_price float_left">
											<div class="x_car_offer_price_inner">
												<h3>$25</h3>
			...
			<div class="row">
				<div class="col-md-3">
					<div class="x_book_logo_wrapper float_left">
						<img src="${pageContext.request.contextPath}/resources/images/white_logo.png" alt="logo">
					</div>
				</div>
				<div class="col-md-6">
						...
						<div class="owl-carousel screen nplr screen-loop">
							<div>
								<div class="card  valign-wrapper">
									...
									<div class="card-image">
										<img src="${pageContext.request.contextPath}/resources/images/client_1.jpg" alt="img">
									</div>
									<!-- /Client's image -->
							...
							<div>
								<div class="card  valign-wrapper">
									<!-- Client's image -->
									<div class="card-image">
										<img src="${pageContext.request.contextPath}/resources/images/client_2.jpg" alt="img">
									</div>
									<!-- /Client's image -->
									<div class="card-content center-align valign">
									<div class="testi_slide_star">
							...
							<div>
								<div class="card  valign-wrapper">
									<!-- Client's image -->
									<div class="card-image">
										<img src="${pageContext.request.contextPath}/resources/images/client_3.jpg" alt="img">
									</div>
									<!-- /Client's image -->
									<div class="card-content center-align valign">
									<div class="testi_slide_star">
							...
							<div>
								<div class="card  valign-wrapper">
									<!-- Client's image -->
									<div class="card-image">
										<img src="${pageContext.request.contextPath}/resources/images/client_4.jpg" alt="img">
									</div>
									<!-- /Client's image -->
									<div class="card-content center-align valign">
									<div class="testi_slide_star">
	...
	<div class="x_why_main_wrapper">
		...
		<div class="container">
			<div class="x_why_left_main_wrapper">
				<img src="${pageContext.request.contextPath}/resources/images/w1.png" alt="car_img">
			</div>
					...
					<div class="btc_ln_slider_wrapper">
						<div class="owl-carousel owl-theme">
							<div class="item">
								<div class="btc_team_slider_cont_main_wrapper">
									<div class="btc_ln_img_wrapper float_left">
										<img src="${pageContext.request.contextPath}/resources/images/ln1.jpg" alt="team_img1">
									</div>
							...
							<div class="item">
								<div class="btc_team_slider_cont_main_wrapper">
									<div class="btc_ln_img_wrapper float_left">
										<img src="${pageContext.request.contextPath}/resources/images/ln2.jpg" alt="team_img1">
									</div>
									<div class="btc_ln_img_cont_wrapper float_left">
							...
							<div class="item">
								<div class="btc_team_slider_cont_main_wrapper">
									<div class="btc_ln_img_wrapper float_left">
										<img src="${pageContext.request.contextPath}/resources/images/ln3.jpg" alt="team_img1">
									</div>
									<div class="btc_ln_img_cont_wrapper float_left">
					...
					<div class="wrap-album-slider">
						<ul class="album-slider">
							<li class="album-slider__item">
								<figure class="album">
									<img src="${pageContext.request.contextPath}/resources/images/prt1.png" alt="img">
								</figure>
							</li>
							<li class="album-slider__item">
								<figure class="album">
									<img src="${pageContext.request.contextPath}/resources/images/prt2.png" alt="img">
								</figure>
							</li>
							<li class="album-slider__item">
								<figure class="album">
									<img src="${pageContext.request.contextPath}/resources/images/prt3.png" alt="img">
								</figure>
							</li>
							<li class="album-slider__item">
								<figure class="album">
									<img src="${pageContext.request.contextPath}/resources/images/prt4.png" alt="img">
								</figure>
							</li>
							<li class="album-slider__item">
								<figure class="album">
									<img src="${pageContext.request.contextPath}/resources/images/prt5.png" alt="img">
								</figure>
							</li>
							<li class="album-slider__item">
								<figure class="album">
									<img src="${pageContext.request.contextPath}/resources/images/prt6.png" alt="img">
								</figure>
							</li>
							<li class="album-slider__item">
								<figure class="album">
	...
	<div class="x_news_letter_main_wrapper">
		<div class="container">
			<div class="x_news_contact_wrapper">
				<img src="${pageContext.request.contextPath}/resources/images/nl1.png" alt="news_img">
			...
			<div class="row">
				<div class="col-xl-3 col-lg-3 col-md-12 col-sm-12 col-12">
					<div class="x_footer_top_left float_left">
						<img src="${pageContext.request.contextPath}/resources/images/footer_logo.png" alt="logo">
					</div>
				</div>

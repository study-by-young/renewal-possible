                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 mb-4">
                                        ...
                                        <div>
                                            ...
                                            <p>보험정보<span class="float-right">수령 시 가입</span></p><div class="clearfix"></div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 mb-4">
                                        <div class="border-bottom mb-2">
                                    ...
                                    <div class="col-12 mb-4">
                                        ...
                                        <div>
                                            ...
                                            <p>보험가<span class="float-right">수령 시 지불</span></p><div class="clearfix"></div>
                                            <p>대여일<span class="float-right">${during}일</span></p><div class="clearfix"></div>
                                            <p>총계<span class="float-right"><fmt:formatNumber value="${(rent.carVO.price * during)}" pattern="#,###"/>원</span></p><div class="clearfix"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>

                    ...
                    <form id="filterForm" name="filterForm" action="#" method="get">
                        <div class="card-body">
                            ...
                            <div class="x_slider_form_input_wrapper form-group">
                                <label class="h6">차량모델</label>
                                <input id="model" name="model" type="text" <c:out value="${pageMaker.cri.type eq 'M'}"/> class="form-control">
                            </div>
                            <!-- 세그먼트 -->
                            <div class="x_car_book_fillter_select_box form-group">
                                <label class="h6">차량등급</label>
                                <select class="select" id="segment" name="segment">
                            ...
                            <!-- 연료 -->
                            <div class="x_car_book_fillter_select_box form-group">
                                <label class="h6">연료</label>
                                <select class="select" id="fuel" name="fuel">
                        ...
                        <div class="card-footer">
                             <button type="button" class="h5 btn btn-block btn-lg btn-primary" onclick="searchCars()"><i class="icon-search4"></i> 상세검색</button>
                        </div>
                    </form>
                </div>
            </div>
                                ...
                                <div class="card-body">
                                    <ul class="nav">
                                        <li class="nav-item px-1">
                                            <label class="mb-0">
                                                <input type="checkbox" value="" name="filter-seg" class="d-none">
                                        ...
                                        <c:forEach var="seg" items="${segments}">
                                            <li class="nav-item px-1">
                                                <label class="mb-0">
                                                    <input type="checkbox" value="${seg.code}" name="filter-seg" class="d-none">
                                                    <button type="button" class="btn btn-outline-primary rounded-pill">${seg.name}</button>
                                                </label>
                                            </li>
                                        </c:forEach>
                                    </ul>

			...
			<div class="col-xl-3 col-lg-4">
				<div class="x_car_book_left_siderbar_wrapper float_left card">
                    ...
                    <div class="x_slider_checout_right card-footer">
                        <a href="#" class="h5 mb-0 btn btn-block btn-primary">예약하기</a>
                    </div>
				</div>
			</div>
			<!-- 차량 상세조회 -->
                            ...
                            <div class="col-12">
                                <div class="card-body">
                                    <div class="border-bottom mb-4">
                                        <ul class="nav nav-tabs justify-content-center nav-tabs-solid rounded border-0 bg-white shadow-0 mb-0">
                                            <li class="nav-item"><a href="#solid-rounded-tab1" class="nav-link rounded-left active" data-toggle="tab">예약정보</a></li>
                                        ...
                                        <div class="tab-pane fade show active" id="solid-rounded-tab1">
                                            <div class="home-tab mb-4">
                                                ...
                                                <div class="border border-grey-400 rounded p-3 text-grey-600">
                                                    <span class="pr-2"><i class="icon-circle-small"></i>${car.year}년식
                                                    </span>
                                                    <span class="pr-2"><i class="icon-circle-small"></i>${car.fuelCodeVO.name}</span>
                                                    <span class="pr-2"><i class="icon-circle-small"></i>${car.segmentCodeVO.name}
                                                    </span>
                                                    <span class="pr-2"><i class="icon-circle-small"></i>${car.passenger}인
                                                    </span>
                                                    <span class="pr-2"><i class="icon-circle-small"></i>${car.colorCodeVO.name}
                                                    </span>
                                                    <span class="pr-2"><i class="icon-circle-small"></i>${car.missionCodeVO.name}
                                                    </span>
                                                    <span class="pr-2"><i class="icon-circle-small"></i>${car.trunk}리터(L)
                                                    </span>
                                                    <span class="pr-2"><i class="icon-circle-small"></i>${car.door}개
                                                    </span>
                                                    <span class="pr-2"><i class="icon-circle-small"></i>${car.kmpl}km/l</span>
                                                </div>
                                            </div>

												...
												<div class="dash"
													...
													<div class="blog_single_comment_heading">
														<h4 style="font-weight: 600; padding-left: 20px;">
															<a href="${pageContext.request.contextPath}/mypage/rent">현재
																진행중인 렌트</a>
														</h4>
													</div>
												</div>
															...
															<div class="col-lg-3 align-self-center">
																<div class="card-img-actions p-3">
																	<img class="card-img-top img-fluid"
																		src="${pageContext.request.contextPath}${est.carVO.modelCodeVO.img}"
																		alt="img">
																</div>
															</div>
																		...
																		<div class="col-lg-3" style="padding-left: 40px;">
																			...
																			<c:if test="${est.review eq '1' }">
																				<a class="btn btn-sm"
																					...
																					style="background: #4f5dec; color: #ffffff;"
																					<c:if test="${est.review eq '0' }"> disabled="disabled"</c:if>>
																					후기작성 </a>
																			</c:if>
																					...
																					<div class="row align-items-center">
																						...
																						<div class="col-8" style="padding-left: 0px">
																							<span class="list-unstyled mb-0">
																								${est.takePlaceBasic} ${est.takePlaceDetail}</span>
																						</div>
																						...
																						<div class="col-8" style="padding-left: 0px">
																							<span class="list-unstyled mb-0">
																								${est.carVO.brandCodeVO.name }
																								${est.carVO.modelCodeVO.name }</span>
																						</div>
											...
											<div class="card-body">
												<div class="row">
													<div class="col-12 text-center">
														<h6 class="py-5">아직 신청한 렌트내역이 없습니다!</h6>
													</div>
												</div>
											</div>
										</c:if>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="dash"
													...
													<div class="blog_single_comment_heading">
														<h4 style="font-weight: 600; padding-left: 20px;">
															<a href="${pageContext.request.contextPath}/mypage/community">최근
																리뷰</a>
														</h4>
													</div>
												</div>
																...
																<div class="card-body">
																	<div class="row">
																		...
																		<div class="col-12">
																			...
																			<p class="text-grey-600">
																				<i class="icon-calendar pr-2 mb-0"> 
																					<fmt:formatDate value="${reviewList.rentHistoryVO.startDate}"
																						pattern="yyyy.MM.dd" />
																					~
									...
									<div class="card">
										<c:if test="${empty reviewList}">
											<div class="card-body">
												<div class="row">
													<div class="col-12 text-center">
														<h6 class="py-5">아직 등록하신 리뷰가 없습니다!</h6>
													</div>
												</div>
											</div>
										</c:if>
									...
									<div class="row">
										<c:forEach var="myCourse" end="3" items="${myCourse}">
											<div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 col-12"
												style="margin-bottom: 15px;">
												<div class="btc_team_bot_cont_main_wrapper" style="margin-top: 0px;">
													<div class="btc_team_img_bot_wrapper">
														<c:if test="${myCourse.firstImage ne null }">
															<img src="${myCourse.firstImage}" alt="Course"
																style="height: 120px">
														</c:if>
